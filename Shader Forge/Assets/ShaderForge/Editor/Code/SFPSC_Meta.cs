...
namespace ShaderForge
{
    ...
    public class SFPSC_Meta : SFPS_Category
    {
		...
		*/
        ...
        private string SerializeCgIncludes()
        {
            string serialized = "";
        ...
        private void DeserializeCgIncludes(string serialized)
        {
        ...
        private void DisplayShaderContext(Rect r)
        {
            ...
            Material temp = new Material(Shader.Find("Hidden/Shader Forge/PresetUnlit")); // This will make it highlight none of the shaders inside.
                                                                                          //TODO: SetupShaderMenu() is obsolete, but no straightforward replacement is suggested, just that ShaderUtil.GetAllShaderInfo() is part of it.
                                                                                          //Perhaps uncomment this if it's causing issues.
